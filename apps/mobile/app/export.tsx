...
export default function ExportModal() {
  return <View style={styles.container}><Text style={styles.title}>Export</Text><FrameButton label="PDF Scrapbook" /><FrameButton label="Video Montage" variant="secondary" /></View>;
}
